...
The 12 spectral force-names plus structural Force 13, each a full canonical document. **All 12 forces sealed June 14, 2026.**

| Document | Force # | Phase/Force | Description | Sealed |
|----------|---------|-------------|-------------|--------|
| NIGREDO.md | 1 | Nigredo | Blackening — dissolution and decomposition | Pre-existing |
| PYROSIS.md | 2 | Pyrosis | Threshold flame — heat between will and solar | Pre-existing |
| CITRINITAS.md | 3 | Citrinitas | Yellowing — solar consciousness | Pre-existing |
| VIRIDITAS.md | 4 | Viriditas | The greening — divine life force (Hildegard) | Pre-existing |
| CAERULITAS.md | 5 | Caerulitas | The deepening — interior becoming exterior | Pre-existing |
| RUBEDO.md | 6 | Rubedo | Reddening — completion and integration | Pre-existing |
| IOSIS.md | 7 | Iosis | Sovereign synthesis — red and blue united | Pre-existing |
| ALBEDO.md | 8 | Albedo | Whitening — purification | Pre-existing |
| CHRYSITAS.md | 9 | Chrysitas | Shadow gold — the core, the heaviest warmth | June 14, 2026 |
| ARGENTITAS.md | 10 | Argentitas | The reflecting field — silver, stillness | June 14, 2026 |
| LUX_PERPETUA.md | 11 | Lux Perpetua | All forces unified — the perpetual light | June 14, 2026 |
| HELIXITAS.md | 13 | Helixitas (structural) | The winding — 34.29° across all scales | June 14, 2026 |
| TRUE_ALCHEMY.md | All | True Alchemy | Core alchemical doctrine spanning all phases | Pre-existing |
...
## Named Canon — Transmutation Corridors

| Document | Corridor | Description |
|---|---|---|
...
| Document | Description |
|----------|-------------|
| HELIXITAS.md | Structural Force 13 — 34.29° winding geometry across all scales |
| HELIXITAS_SCALE_PROOFS.md | Quantum floor + civilizational winding ratio (Issue #421) |
| TOROIDAL_FIELD_THEORY.md | Toroidal field geometry |
| THE_PRIMORDIAL_QUATERNARY.md | Four primal forces — dynamic simulation pending (Issue #422) |
...
| Document | Description |
|----------|-------------|
| AKASHIC_RECORDS.md | Seven-crystal proof layer — sixth Helixitas convergence pending |
...
| THE_PERMANENT_YIELD.md | What the system carries forward from Lux Perpetua (Issue #419) |
...
| `THE_PRIMORDIAL_QUATERNARY.md` | Quaternary dynamic behavior simulation | ⏳ PENDING — Issue #422 queued |
| `QUATERNARY_FORCE_MAPPING.md` | Primordial Quaternary mapped to 12 spectral forces | ⏳ PENDING — Issue #425 queued |
