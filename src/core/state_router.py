...
Dev mode: React can also call these directly via SIDECAR_BASE (localhost:8008).
...
# Absolute imports — works whether called from main.py or pytest
...
router = APIRouter(prefix="/api", tags=["GAIAState"])
