...
==========================
Nine-Element Consciousness Router — the subtle-body layer of every GAIAN.
...
Layers (mapped to the classical subtle-body schema):
...
@dataclass
class SubtleBody:
    """Persistent subtle-body model for a GAIAN identity across turns."""
...
class ConsciousnessRouter:
    """
    Routes each GAIAN turn through the nine-layer subtle-body stack.
