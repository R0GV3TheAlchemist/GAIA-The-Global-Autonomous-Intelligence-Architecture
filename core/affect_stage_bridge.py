"""
core.affect_stage_bridge
========================
Wires AffectInference (core/affect_inference.py) to StageEngine
(core/stage_engine.py).

Previously located at core/stage_bridge.py, which was silently shadowed
by the core/stage_bridge/ package directory (types.py only).
Rescued here as part of the Phase 2 alignment pass (June 2026).

Note on naming
--------------
This module is intentionally named affect_stage_bridge to avoid
shadowing the core/stage_bridge/ package which exports data contracts
(FeelingState dataclass) used by the broader stage sub-system.
