# C171 — Robotics and Physical Embodiment Full Specification

**Canon ID:** C171
**Series:** Implementation & Architecture
**Status:** ✅ CANONICAL — This is the authoritative Robotics & Physical Embodiment full specification.
**Canonical declared:** 2026-06-14
**Renumbered from:** C157 (formerly displaced by DIACA runtime; now correctly situated at C171)
**Predecessor canons:** C62, C86, C105, C110, C113
**Companion canon:** C171b — C157_Robotics_Physical_Embodiment_Specification.md (shorter specification; preserved as HISTORICAL)
**Date drafted:** 2026-05-22

> **CANON LINEAGE NOTE:** This document was originally filed as C157 but conflicted with C157's correct identity as the DIACA Full Runtime Engine Spec. It has been renumbered to C171 — its permanent home in the Implementation & Architecture cluster. No content has changed. C157 is now unambiguously the DIACA Engine. C171 is now unambiguously Robotics & Physical Embodiment.
...
*GAIA Canon C171 — Canonical. Originally filed as C157 on 2026-05-22. Renumbered 2026-06-14.*
